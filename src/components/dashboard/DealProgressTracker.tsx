  ...
  const deals = [
    {
      ...
      probability: 85,
      stakeholderDetails: [
        { name: 'Alex Brown', role: 'VP Procurement', lastContact: '2024-01-08', progress: 80 },
        { name: 'Nina Patel', role: 'Legal Counsel', lastContact: '2024-01-06', progress: 60 },
        { name: 'Tom Lee', role: 'Finance Manager', lastContact: '2024-01-09', progress: 70 },
        { name: 'Emma Davis', role: 'Procurement Analyst', lastContact: '2024-01-07', progress: 35 },
      ]
    },
    {
      id: 2,
      ...
      probability: 65,
      stakeholderDetails: [
        { name: 'Laura Smith', role: 'CTO', lastContact: '2024-01-05', progress: 50 },
        { name: 'Peter Wu', role: 'Engineering Lead', lastContact: '2024-01-07', progress: 45 },
      ]
    },
    {
      id: 3,
      ...
      probability: 70,
      stakeholderDetails: [
        { name: 'Mark Allen', role: 'Product Owner', lastContact: '2024-01-09', progress: 40 },
        { name: 'Jenny Kim', role: 'Operations Manager', lastContact: '2024-01-10', progress: 35 },
        { name: 'Carlos Diaz', role: 'IT Director', lastContact: '2024-01-08', progress: 50 },
      ]
    },
    {
      id: 4,
      ...
      probability: 45,
      stakeholderDetails: [
        { name: 'Priya Singh', role: 'Head of Ops', lastContact: '2024-01-03', progress: 30 },
        { name: 'Ethan Clark', role: 'CFO', lastContact: '2023-12-29', progress: 20 },
        { name: 'Sophie Martin', role: 'Project Lead', lastContact: '2024-01-02', progress: 25 },
      ]
    },
    {
      id: 5,
      ...
      probability: 62,
      stakeholderDetails: [
        { name: 'Jason Moore', role: 'CFO', lastContact: '2024-01-07', progress: 55 },
        { name: 'Angela Ruiz', role: 'Compliance Lead', lastContact: '2024-01-06', progress: 50 },
      ]
    },
    {
      id: 6,
      ...
      probability: 88,
      stakeholderDetails: [
        { name: 'Grace Huang', role: 'VP Engineering', lastContact: '2024-01-09', progress: 85 },
        { name: 'Robert King', role: 'Procurement Lead', lastContact: '2024-01-08', progress: 70 },
        { name: 'Mia Lopez', role: 'Finance Analyst', lastContact: '2024-01-09', progress: 75 },
      ]
    }
  ];
